...
data(test_conservative_pc_data1)
## set.seed(67*37)
...
## generate n samples of DAG using standard normal error distribution
##random data
data(test_conservative_pc_data2)
## set.seed(67*67)
## new.mat <- rmvnorm(n,mean=rep(0,p),sigma=trueCov(g))
...
## save(new.mat, file = "/u/kalisch/research/packages/pcalg/data/test_conservative_pc_data3.rda")
## load(file = "/u/kalisch/research/packages/pcalg/data/test_conservative_pc_data3.rda")
data(test_conservative_pc_data3)
